...
class GameLoop:
    ...
    def _handle_input_targeting_ability(self):
        ...
        if self.input_service.is_mouse_clicked():
            ...
            habilidad_nombre = self.context.pending_action
            resultado = selected_entity.usar_habilidad(habilidad_nombre, objetivo, battle)
            print(resultado)
            self._clear_selection()
    ...
    def _handle_action_selection(self, action_type: str, entity: BattleEntity):
        ...
        elif action_type in entity.habilidades:
            # Preparar habilidad
