...
class ActionMenu:
    ...
    def _build_available_actions(self) -> List[dict]:
        ...
        for nombre, habilidad in self.entity.habilidades.items():
            actions.append({
                "name": habilidad.nombre,
                "key": nombre[0].upper(),  # Primera letra como tecla rápida
                "type": nombre,
                "enabled": self.entity.puede_usar_habilidad(nombre),
