        ...
        if (game_context.current_state == GameState.TRACING_ROUTE and 
            ...
            if selected_entity:
                ...
                if game_context.current_route.path:
                    ...
                    # Dibuja la línea verde alineada con el centro de cada celda de la ruta
                    route_points = [cell_center(selected_entity.position)] + [cell_center(pos) for pos in game_context.current_route.path]
                    if len(route_points) > 1:
                        pygame.draw.lines(self.screen, (0,255,0), False, route_points, 4)
